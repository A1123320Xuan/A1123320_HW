...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'a1123320@mail.nuk.edu.tw';
    $mail->Password   = 'lpbf bztd pzzp woki';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
    $mail->Port       = 465;

    $mail->setFrom('a1123320@mail.nuk.edu.tw', 'Mailer');
    $mail->addAddress('aa159951753@gmail.com'); 
    $mail->addAddress($to); 
